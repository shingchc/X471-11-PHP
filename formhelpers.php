...
//print a search box
function input_search($element_name, $values, $placeholder)   {
    print '<input type=text" name="' . $element_name .'" placeholder="' . $placeholder .'" value="';
    print htmlentities($values[$element_name]) . '">';
    print '<input hidden="true" type="submit" value="Search" />';
}
